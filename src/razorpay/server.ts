...
console.log("");
console.log("Razorpay needs a public URL, and blacklists several tunnels for");
console.log("security. ngrok.io, loca.lt, webhook.site, requestbin.com and");
console.log("hookbin.com will NOT deliver. Razorpay recommends zrok:");
console.log(`  zrok share public ${server.port}`);
console.log("A staging endpoint is safer still.");
console.log("");
console.log(`Register  <public-url>${WEBHOOK_PATH}  in the Dashboard under`);
console.log("Settings > Webhooks with the same secret as RAZORPAY_WEBHOOK_SECRET,");
console.log("subscribing to payment_link.paid, payment_link.partially_paid and");
console.log("payment_link.expired. Test mode prompts for OTP 754081.");
console.log("");
console.log("If the secret is ever rotated, retries of older deliveries must be");
console.log("validated with the OLD secret.\n");
